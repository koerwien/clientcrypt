(function (global, factory) {
	...
	*/
	...
	const newNonce = () => naclFast.randomBytes(naclFast.secretbox.nonceLength);
	...
	const encrypt = (message, key) => {
	  ...
	  const box = naclFast.secretbox(messageArray, nounce, keyArray);
	...
	const decrypt = (cypherArray, key) => {
	  ...
	  const cypherArrayWithoutNounce = cypherArray.slice(naclFast.secretbox.nonceLength, cypherArray.length);
